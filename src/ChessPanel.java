...
public class ChessPanel extends JPanel{
    ...
    // 边界值,用于速度优化
    protected int x_max = 15;
    protected int x_min = 0;
    protected int y_max = 15;
    ...
    public final int BLACK_ONE=0;                   //0表黑子
    public final int WHITE_ONE=1;                   //1表白子
    public final int NONE_ONE=2;                    //2表无子
    public final int N=15;                           //棋盘边长
